...
<v-container>
  ...
  <div>
    <h1 align="center" style="font-size:24px;margin:0;">Breyta Skólakorti</h1> <br>
    ...
    <v-btn @click="editSkort" depressed color="primary">Vista breytingu</v-btn>
...
import { NotificationProgrammatic as Notification } from 'buefy'
  ...
  export default {
    ...
    async fetch() {
    axios.get(`http://localhost:1337/skolakorts/${this.$route.params.id}`)
    .then(response => {
    ...
    async editSkort(e) {
        e.preventDefault();
        let currentObj = this;
        const res = await axios.put(`http://localhost:1337/skolakorts/${this.$route.params.id}`, {
          nafn: this.post.nafn,

  ...
  >
    ...
    <v-list-item five-line>
      <v-list-item-content>
        ...
        <!-- <n-link :to="`/${post.id}`"><v-icon class="ml-16">mdi-clipboard-edit-outline</v-icon></n-link> -->
        <!-- <v-icon class="ml-16">mdi-clipboard-edit-outline</v-icon> -->
        </nuxt-link>
        </div>
...
import editskolakort from './editskolakort'
